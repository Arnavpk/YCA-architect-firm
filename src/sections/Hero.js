...
const SLIDE_IMAGES = [
  ...
  'https://res.cloudinary.com/dmjaisk94/image/upload/v1786904900/7D2AF0F1-C2FC-4FAF-8906-0194B879828F_duerf5.png',
  'https://res.cloudinary.com/dmjaisk94/image/upload/v1786904793/DFB79894-C02F-4508-A161-567AAFA73E9F_grriwr.png',
  'https://res.cloudinary.com/dmjaisk94/image/upload/v1785406825/The_Grand_Shaurya_19_of_25_1_vk4p3j.jpg',
...
export default function Hero() {
  ...
  const playCaptionOut = useCallback(() => {
    return gsap
      .timeline()
      .to(
        [captionRef.current, subRef.current],
        {
          y: -60,
          opacity: 0,
          duration: 0.5,
  ...
  useEffect(() => {
    ...
    const heroImage = containerRef.current?.querySelector(
      '.hero-image.active'
    );
  ...
  return (
    ...
    >
      ...
      <div
        ref={overlayRef}
        className="hero-overlay-mask absolute inset-0 bg-charcoal z-10"
      />
      ...
      <div className="relative z-20 h-full flex flex-col justify-end px-6 md:px-12 lg:px-16 pb-16 md:pb-24">
        <div className="max-w-5xl">
          <h1
            ref={captionRef}
            className="font-serif text-display text-white leading-[1.2] mb-8"
          >
