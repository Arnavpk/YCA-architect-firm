      ...
      <section className="py-16 md:py-24 px-6 md:px-12 lg:px-16 bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            {submitted ? (
              ...
              <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <label className="text-[11px] tracking-[0.15em] uppercase text-dark-grey/60 mb-2 block">{t('contactPage.formName')} *</label>
                  ...
                  <div>
                    <label className="text-[11px] tracking-[0.15em] uppercase text-dark-grey/60 mb-2 block">{t('contactPage.formEmail')} *</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <label className="text-[11px] tracking-[0.15em] uppercase text-dark-grey/60 mb-2 block">{t('contactPage.formPhone')}</label>
                  ...
                  <div>
                    <label className="text-[11px] tracking-[0.15em] uppercase text-dark-grey/60 mb-2 block">{t('contactPage.formService')}</label>
          ...
          <div ref={infoRef} className="opacity-0 space-y-10">
            ...
            <div className="mt-8"><div className="aspect-[4/3] bg-warm-beige overflow-hidden"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.321301429119!2d74.56922387515303!3d16.85999318394004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc1186a5998ac8d%3A0x1f81adc7271b899b!2sYOGESH%20CHAVAN%20ASSOCIATES!5e0!3m2!1sen!2sin!4v1785824384724!5m2!1sen!2sin" width="100%" height="100%" style={{ border: 0 }} allowFullScreen="" loading="lazy" title="YCA Studio Location" /></div></div>
          </div>
        </div>
      </section>
    </>
